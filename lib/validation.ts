...
export const QuoteRequestSchema = z.object({
  ...
  workType: z.string({ required_error: "Please select a work type." }),
  ...
  complianceContext: z.string({ required_error: "Please select a compliance context." }),
  meetingLength: z.enum(["30", "45"], { required_error: "Please select a meeting length." }),
